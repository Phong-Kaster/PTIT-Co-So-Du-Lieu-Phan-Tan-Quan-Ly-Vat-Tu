...
namespace QLTVT
{
    public partial class FormVatTu : Form
    {
        ...
        private void btnGHI_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            int soLuongTon = int.Parse(drv["SOLUONGTON"].ToString());
            Console.WriteLine("TEN VAT TU HIEN TAI TRUOC KHI AN OK");
            Console.WriteLine(tenVatTu);
            Console.WriteLine(donViTinh);
            Console.WriteLine(soLuongTon);
